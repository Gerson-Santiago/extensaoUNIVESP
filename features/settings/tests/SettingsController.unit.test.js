...
describe('SettingsController', () => {
    ...
    describe('handleImport', () => {
        ...
        it('deve exibir erro se a validação da importação falhar', async () => {
            ...
            expect(mockToaster.show).toHaveBeenCalledWith(expect.stringContaining('Erro na importação'), 'error');
        ...
        it('deve lidar com erro crítico na leitura do arquivo', async () => {
            ...
            expect(mockToaster.show).toHaveBeenCalledWith(expect.stringContaining('Falha crítica'), 'error');
        });
    });
    ...
    describe('handleReset', () => {
        ...
        it('deve tratar erro no reset', async () => {
            ...
            expect(mockToaster.show).toHaveBeenCalledWith(expect.stringContaining('Falha ao resetar'), 'error');
