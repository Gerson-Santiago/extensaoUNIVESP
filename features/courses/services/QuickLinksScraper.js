...
export class QuickLinksScraper {
  ...
  static async scrapeFromQuickLinks(_weekUrl, tabId) {
    ...
    const results = await chrome.scripting.executeScript({
      target: { tabId: tabId },
      func: DOM_scrapeQuickLinks_Injected,
    });
...
/**
 * Função injetada no navegador para abrir e ler o modal de Links Rápidos.
 * Deve ser autocontida (não depender de imports externos).
 */
export async function DOM_scrapeQuickLinks_Injected() {
