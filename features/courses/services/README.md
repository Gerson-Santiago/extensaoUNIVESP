...
| **[WeekActivitiesService.js](file:///home/sant/extensaoUNIVESP/features/courses/services/WeekActivitiesService.js)** | Busca ou scrapa atividades de uma semana específica (com cache). **SafeResult pattern v2.9.1**. | `WeekContentScraper`, `ActivityRepository` (localStorage) |
