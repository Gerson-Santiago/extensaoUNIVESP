...
describe('Integration: Task Management Flow', () => {
    ...
    test('should display tasks preview when "Tarefas" button is clicked', async () => {
        ...
        expect(WeekContentScraper.scrapeWeekContent).toHaveBeenCalledWith('https://ava.univesp.br/semana1');
    ...
    test('should show error toast if scraping fails', async () => {
        ...
        // 2. Mock Error
        /** @type {jest.Mock} */ (WeekContentScraper.scrapeWeekContent).mockRejectedValue(new Error('Network Error'));
