...
describe('NavigationService', () => {
    beforeEach(() => {
        ...
        // Default mocks
        /** @type {jest.Mock} */ (Tabs.openOrSwitchTo).mockResolvedValue({ id: 999, windowId: 111, url: 'http://week-url' });

    /** @type {jest.Mock} */ (chrome.scripting.executeScript).mockResolvedValue([{ result: true }]);
    });

    describe('openActivity', () => {
        const weekUrl = 'https://ava.univesp.br/webapps/blackboard/content/listContent.jsp?course_id=_123_1&content_id=_WEEK_1';
