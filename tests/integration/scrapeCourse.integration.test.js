...
describe('Integration: Scrape Course Flow', () => {
    ...
    beforeEach(() => {
        ...
        // Mock Storage
        /** @type {jest.Mock} */ (chrome.storage.sync.get).mockImplementation((keys, callback) => callback({}));
        ...
        /** @type {jest.Mock} */ (chrome.tabs.query).mockImplementation((query, callback) => {
            callback([{ id: 123, url: 'https://ava.univesp.br/ultra/courses/_123_1/cl/outline', title: 'Matéria Real - Univesp' }]);
        });
